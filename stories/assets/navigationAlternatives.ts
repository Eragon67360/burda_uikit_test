...
export const focusNavigation: NavigationArgs = {
  ...
  navigationItems: [
    ...
    },
    {
      ...
      order: 2,
      label: 'FOCUS+',
      flyoutItems: [{ label: 'FOCUS+', href: '/focus', target: '_self' }],
    },
    {
      type: 'flyout',
      order: 3,
      label: 'Einzelausgaben',
      flyoutItems: [{ label: 'Einzelausgaben', href: '/einzelausgaben', target: '_self' }],
    },
  ],
  ...
  navigationItems: [
    {
      ...
      order: 1,
      label: 'Zeitschriften',
      flyoutItems: [{ label: 'Zeitschriften', href: '/focus', target: '_self' }],
    },
    {
      type: 'flyout',
      order: 2,
      label: 'Digital',
      flyoutItems: [{ label: 'Digital', href: '/einzelausgaben', target: '_self' }],
    },
    {
      type: 'flyout',
      order: 3,
      label: 'Aboarten',
      flyoutItems: [{ label: 'Aboarten', href: '/focus', target: '_self' }],
    },
    {
      type: 'flyout',
      order: 4,
      label: 'Prämien',
      flyoutItems: [{ label: 'Prämien', href: '/einzelausgaben', target: '_self' }],
    },
  ],
  hasSearch: true,
  searchProps: {
...
export const autoMotorUndSportNavigation: NavigationArgs = {
  ...
  navigationItems: [
    ...
    },
    {
      ...
      flyoutItems: [{ label: 'Einzelhefte & Produkte', href: '/einzelausgaben', target: '_self' }],
      alwaysFlyout: false,
    },
    {
      type: 'flyout',
      order: 3,
      label: 'Events',
      flyoutItems: [{ label: 'Events', href: '/focus', target: '_self' }],
      alwaysFlyout: false,
    },
  ],
  hasLanguageDropdown: true,
