import { FooterArgs } from '../components/Footer/Footer';
import { IconRegistry, IconCategory } from './icons';

export const meinSchoenerGartenFooter: FooterArgs = {
  column1: {
    logo: {
      src: '/msgarten_inverted.png',
      alt: 'Company Logo',
      width: 315,
    },
    phone: {
  ...
  column2: {
    title: 'Mein schöner Garten Abo-Shop',
    links: [
  ...
  column3: {
    ...
    secondSection: {
      ...
      description:
        'Sichern Sie sich jetzt alle Vorteile als Abonnent des Magazins. Keine Ausgabe des FOCUS-Magazins mehr verpassen, pünktliche Lieferung direkt nach Hause und das zum gleichen Preis wie am Kiosk. Zudem können Sie als FOCUS Abonnent aus vielen verschiedenen Prämien auswählen!\nIn dem FOCUS Abo- Shop haben Sie die Möglichkeit, aus verschiedenen Abos zu wählen: ',
    },
    specialLinks: [
...
export const focusFooter: FooterArgs = {
  column1: {
    logo: {
      src: '/burda_logo.png',
      alt: 'Company Logo',
...
export const autoMotorUndSportFooter: FooterArgs = {
  column1: {
    logo: {
      src: '/automotor_logo.png',
      alt: 'Company Logo',
      width: 200,
    },
    phone: {
