...
export const createProcess = ({
  ...
  items.forEach((item, index) => {
    ...
    orderBadge.className = `w-10 h-10 text-copy-mobile rounded-full flex items-center justify-center mb-3 ${backgroundColor === 'white' ? 'bg-secondary-interaction text-base-black' : 'bg-primary-interaction text-base-white'}`;
