...
export const Desktop: Story = {
  ...
  render: (args) => {
    ...
    topContent.innerHTML =
      '<h1 style="text-align: center; padding-top: 200px;" class="w-[42rem] mx-auto">Scroll down to see Navigation behavior<br><p class="font-bold mt-8">Please click on the upper right Fullscreen button (alt+F) and change the size of the preview (top left) to see the widescreen behavior</p></h1>';
...
export const DesktopWith2Logos: Story = {
  parameters: {
    viewport: {
      defaultViewport: 'desktop',
    },
  ...
  render: (args) => {
    ...
    const createAddItemModal = () => {
        ...
        if (typeSelect.value === 'link') {
          ...
          addFlyoutItemButton.onclick = () => {
            ...
            removeButton.className =
              'bg-primary-interaction hover:bg-primary-dark transition duration-300 cursor-pointer text-base-white px-2 rounded';
      ...
      saveButton.className =
        'bg-secondary-interaction hover:bg-secondary-light transition duration-300 text-base-black px-4 py-2 rounded cursor-pointer';
      saveButton.onclick = () => {
    ...
    toggle2LinesButton.className =
      'bg-tertiary hover:bg-tertiary/80 transition duration-300 text-base-black px-4 py-2 rounded cursor-pointer';
    ...
    const updateCurrentItems = () => {
      ...
      args.navigationItems.forEach((item, index) => {
        ...
        removeButton.className =
          'ml-2 bg-primary-interaction hover:bg-primary-light transition duration-300 text-base-white text-xs px-2 py-1 rounded cursor-pointer';
...
export const MobileNavigation: Story = {
  ...
  render: (args) => {
    ...
    topContent.style.backgroundColor = '#f0f0f0';
    topContent.innerHTML =
      '<h1 style="text-align: center; padding-top: 200px; width: 75%; margin-inline: auto">Scroll down to see Navigation behavior</h1>';
