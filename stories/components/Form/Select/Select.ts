...
export const createSelect = ({ placeholder, items, labelText, labelPosition, disabled = false, multiple = false }: SelectArgs) => {
  const labelClasses = labelPosition === 'beside' ? 'flex items-center gap-2' : 'flex flex-col gap-1';
